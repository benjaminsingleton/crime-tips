                                ...
                                <div className="feed-activity-list">
                                    <div className="feed-element">
                                        <div className="media-body">
                                            <small className="pull-right">5m ago</small> <strong>Ben Singleton</strong> added a new tip.
                                            <br/>
                                    ...
                                    <div className="feed-element">
                                        <div className="media-body">
                                            <small className="pull-right">5m ago</small> <strong>Ben Singleton</strong> reviewed and closed a tip.
                                            <br/>
                                            <small className="text-muted">Today 5:60 pm - 12.06.2014</small>
                                        </div>
                                    </div>
                                    <div className="feed-element">
                                        <div className="media-body">
                                            <small className="pull-right">5m ago</small> <strong>Ben Singleton</strong> posted a new blog.
                                            <br/>
                                            <small className="text-muted">Today 5:60 pm - 12.06.2014</small>
                                        </div>
                                    </div>
