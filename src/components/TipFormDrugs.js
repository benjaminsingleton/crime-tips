  ...
  return (
    <div>
      <div style={{color: gray500,fontSize: '12px'}}>
        All of our questions are optional so feel free to skip any questions you can’t
        answer. That said, the more details you can provide, the better we can do our
        job.
      </div>
